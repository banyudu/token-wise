# Sourced (not executed) by release scripts. Exports signing and notarization
# env from the macOS Keychain + on-disk keys. Reads nothing from
# committed files.
#
...
: "${APPLE_API_KEY:=$_p8_id}"        # read by notarization tooling
